...
const translations = {
  pt: {
    ...
    settingsCookiesStep1: 'Instale a extensão <b>Get cookies.txt LOCALLY</b> no Chrome ou Edge.',
  ...
  en: {
    ...
    settingsCookiesStep1: 'Install the <b>Get cookies.txt LOCALLY</b> extension on Chrome or Edge.',
  ...
  es: {
    ...
    settingsCookiesStep1: 'Instala la extensión <b>Get cookies.txt LOCALLY</b> en Chrome o Edge.',
